...
wtheme <- function(title.font = "OpenSans-CondensedBold", base.font = "OpenSans-CondensedLight", legend.text.size = 16) {
  theme(
    plot.title = element_text(family = title.font, size = 21, margin = margin(b = 32), colour = "#404040"),
...
for(lang in colnames(txt)) {
  ...
  wf <- lapply(totF$geo_code, function(iso) {
    ...
    legend.text.size <- ifelse(lang %in% c('ZH', 'JA'), 12, 14.5)
  ...
  png(w.path,  res = 250, pointsize = 12, height = 4770, 
      width = 2000)
