  ...
  colour = colourText_bkbg
   ...
   theme_bw() + 
    theme(
      ...
      legend.text = element_text(colour = colourText_bkbg, size = 6, hjust = 1, family = "Open Sans Condensed"), ############# 
      legend.title = element_text(colour = colourText_bkbg, size = 9, family = "Open Sans Condensed"),
